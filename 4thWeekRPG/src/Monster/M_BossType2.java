...
public class M_BossType2 extends M_Boss{
    public M_BossType2(int monsterPlaceY, int monsterPlaceX, GameMap map) {
        super(monsterPlaceY, monsterPlaceX, map);
        map.mapArray[monsterPlaceY][monsterPlaceX] = "Boss2";
    }

    // int 리턴값에 따라 상태이상 종류 - 0은 이상없음
    @Override
    public int m_skill(Player player, Monster monster){
        System.out.println("2보스 스킬발동 - 화상");
